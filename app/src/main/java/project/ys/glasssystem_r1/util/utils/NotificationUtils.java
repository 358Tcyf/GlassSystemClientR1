...
public class NotificationUtils {
    ...
    public static void showNotification(Context context) {
        Notification notification = new NotificationCompat.Builder(context)
                ...
                .setContentIntent(PendingIntent.getActivity(context, 1, new Intent(context, HomeFragment_.class), PendingIntent.FLAG_CANCEL_CURRENT))
                .build();
...
//        notificationManager.notify(4, notify);
    ...
    public static void SimplifiedNotification(Context context, String title, String text) {
