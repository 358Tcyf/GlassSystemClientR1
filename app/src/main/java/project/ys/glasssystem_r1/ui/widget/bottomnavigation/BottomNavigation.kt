...
package project.ys.glasssystem_r1.ui.widget.bottomnavigation
...
class BottomNavigation : FrameLayout {
    ...
    private fun setAttributeFromXml(context: Context, attrs: AttributeSet) {
        ...
        try {
            a?.apply {
                defaultIconColor = getColor(R.styleable.BottomNavigation_mbn_defaultIconColor, defaultIconColor)
                selectedIconColor = getColor(R.styleable.BottomNavigation_mbn_selectedIconColor, selectedIconColor)
                backgroundBottomColor = getColor(R.styleable.BottomNavigation_mbn_backgroundBottomColor, backgroundBottomColor)
                countTextColor = getColor(R.styleable.BottomNavigation_mbn_countTextColor, countTextColor)
                countBackgroundColor = getColor(R.styleable.BottomNavigation_mbn_countBackgroundColor, countBackgroundColor)
                val typeface = getString(R.styleable.BottomNavigation_mbn_countTypeface)
                rippleColor = getColor(R.styleable.BottomNavigation_mbn_rippleColor, rippleColor)
                shadowColor = getColor(R.styleable.BottomNavigation_mbn_shadowColor, shadowColor)
    ...
    fun add(model: Model) {
        ...
        cell.apply {
            ...
            layoutParams = params
            defaultIcon = model.defaultIconColor
    ...
    fun isSameSelect(): Boolean {
        return selectedId == preSelectedId
    }
    ...
    class Model(var id: Int, var defaultIconColor: Int, var selectedIcon: Int) {
